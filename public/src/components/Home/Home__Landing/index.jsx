...
const Landing = () => {
  return(
    <div className="landing">
      ...
      <svg className="landing__overlay" xmlns="http://www.w3.org/2000/svg" width="1920" height="1080">
        <rect id="Rectangle_10" data-name="Rectangle 10" width="1920" height="1080" opacity="0.36" fill="#000000"/>
      </svg>
      <div className="mouse">
